...
Чтобы не настраивать всё самостоятельно, можно воспользоваться docker-образом, описанным в `Dockerfile`. После входа в docker-контейнер (или после самостоятельной установки библиотек) можно установить проект через git:
```shell
